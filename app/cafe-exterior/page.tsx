...
export default function CafeExteriorPage() {
  return (
    <div>
      ...
      <p className="mt-4 text-lg whitespace-pre-line">{content.cafe.text}</p>
      ...
      <div className="mb-6">
        ...
        <p className="mb-2">________________________________________________________________________________________________________________________________________________</p>
      </div>
